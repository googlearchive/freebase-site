var MF = {
  "apps": {
      ...
      "schema": "//7.schema.site.freebase.dev",
...
acre.require(MF.apps.core + "/MANIFEST").init(MF, this, {"image_base_url": "http://freebaselibs.com/static/freebase_site/apps/f5ff611436c240cd63a734492cc5e2c7", "static_base_url": "http://freebaselibs.com/static/freebase_site/apps/f5ff611436c240cd63a734492cc5e2c7"});
