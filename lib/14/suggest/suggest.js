(function($, undefined){
     ...
     $.suggest = function(name, prototype) {
         ...
         $.suggest[name] = function(input, options) {
             ...
             $.each(["type", "type_strict", "mql_filter",
                     "as_of_time", "exclude_guids", "category", "all_types", "filter"],
                    function(i,n) {
                        var v = o[n];
                        if (v === null || v === "") {
                            return;
             ...
             // ask for all names as unescaped
             // however, ensure they are inserted to the DOM with document.createTextNode()
             // TODO:remove
             //o.ac_param.html_escape = false;
     ...
     $.extend($.suggest.suggest, {
                  ...
                  defaults: {
                      ...
                      service_url: "http://www.googleapis.com",
                      ...
                      flyout_service_path: "/suggest/flyout",
